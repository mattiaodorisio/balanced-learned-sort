...
// https://github.com/anikristo/LearnedSort/blob/master/src/utils.h
template <class T>
long long int get_checksum(std::vector<T> arr) {
  ...
  std::vector<T> cpy(arr.begin(), arr.end());
...
// Util function for log and debug
template <typename RandomIt>
static inline void print_iter(RandomIt begin, RandomIt end) {
...
// Util function for log and debug
template <typename RandomIt>
static inline void dump_vector(RandomIt begin, RandomIt end, std::string file_name, long counter = -1) {
